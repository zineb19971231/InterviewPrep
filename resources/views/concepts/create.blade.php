<x-app-layout>
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <a href="{{ route('domains.concepts.index', $domain) }}" class="inline-flex items-center gap-2 text-sm text-surface-500 hover:text-surface-700 transition-colors">
        ...
        <div class="card">
            <div class="px-6 py-5 border-b border-surface-200">
                <h1 class="text-xl font-bold text-surface-900">Nouveau concept</h1>
                <p class="mt-1 text-sm text-surface-500">Ajoutez un concept technique à maîtriser</p>
            </div>

            <form method="POST" action="{{ route('domains.concepts.store', $domain) }}" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="status" name="status" required class="input appearance-none">
                ...
                <div class="flex items-center justify-end gap-4 pt-4 border-t border-surface-200">
                    <a href="{{ route('domains.concepts.index', $domain) }}" class="text-sm font-medium text-surface-500 hover:text-surface-700 transition-colors">
                        Annuler
                    </a>
