    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="card">
            <div class="px-6 py-5 border-b border-surface-200">
                <h1 class="text-xl font-bold text-surface-900">Nouveau domaine</h1>
                <p class="mt-1 text-sm text-surface-500">Créez un domaine technique pour organiser vos concepts</p>
            </div>
